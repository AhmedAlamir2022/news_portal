...
class FooterGridTwoController extends Controller
{
    ...
    {
        $footerTitle = FooterTitle::where('key' , 'grid_two_title')->first();
        $footer = FooterGridTwo::all();
        return view('admin.footer-grid-two.index', compact('footer', 'footerTitle'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $footer->save();
        return redirect()->route('admin.footer-grid-two.index')->with('success', 'Created Successfully!');
    ...
    public function update(Request $request, string $id)
    {
        ...
        $footer->status = $request->status;
        $footer->save();
        return redirect()->route('admin.footer-grid-two.index')->with('info', 'Updated Successfully!');
    }
